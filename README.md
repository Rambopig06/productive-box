...
> This project is inspired by an awesome pinned-gist project.<br/>Find more in https://github.com/matchai/awesome-pinned-gistsll
...
1. Add the following environment variables:
   - **GH_TOKEN:** The GitHub token generated above.kjnkj
